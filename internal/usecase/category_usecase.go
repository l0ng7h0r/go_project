...
func (u *CategoryUsecase) CreateCategory(name string) (string, error) {
	return u.categoryRepo.CreateCategory(&domain.Category{Name: name})
}
...
func (u *CategoryUsecase) UpdateCategory(id string, name string) error {
	return u.categoryRepo.UpdateCategory(id, &domain.Category{Name: name})
}
